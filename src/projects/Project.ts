export class Project {
    ...
    // 'initializer?: any' used because we have multiple types defined in Model
    constructor (initializer?: any) {
        // if initializer does not exist return function
        if (!initializer) return;
        // if (initializer.property) used to null-check before moving forward to 'this'
        // you could be very bold and skip the if (...)
